      ...
      <div class="card main-card shadow no-copy">
        ...
        <div class="description-section bg-light p-3 border-bottom">
          <div class="container">
            <p class="description-text mb-0">
              ...
              | <strong>Điều kiện:</strong> Thí sinh thi tốt nghiệp THPT năm 2025 hoặc thí sinh đã tốt nghiệp THPT các năm trước. Điểm trung bình các môn học trong tổ hợp xét tuyển phải đạt điểm sàn đầu vào.
            </p>
          </div>
        </div>
        ...
        <div class="card-body">
          <div v-if="loading" class="text-center py-5">
            ...
            <p class="mt-3 fs-5">Đang tải dữ liệu xét tuyển học bạ...</p>
          </div>
