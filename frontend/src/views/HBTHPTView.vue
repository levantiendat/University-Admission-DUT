<template>
  <div class="hocba-container">
    <div class="container-fluid py-2 py-md-3">
      <article class="card main-card shadow-sm">
        <!-- Header Section with improved accessibility -->
        <header class="card-header bg-primary text-white" aria-labelledby="hocba-title">
          <div class="d-flex justify-content-center align-items-center">
            <div class="header-icon me-2" aria-hidden="true">
              <i class="bi bi-journal-check"></i>
            </div>
            <h1 id="hocba-title" class="mb-0 fs-5">XÉT TUYỂN THEO KẾT QUẢ HỌC TẬP CẤP THPT</h1>
          </div>
        </header>
        ...
        <div class="description-section bg-light p-2 border-bottom">
          <div class="container">
            ...
            <div class="accordion accordion-flush" id="announcementAccordion">
              <!-- Introduction -->
              <p class="mb-2 small">Trường Đại học Bách khoa, Đại học Đà Nẵng thông báo tuyển sinh đào tạo trình độ đại học chính quy vào các ngành thuộc Trường năm 2025 theo phương thức xét kết quả học tập cấp THPT (học bạ).</p>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed p-2 fs-7" type="button" data-bs-toggle="collapse" data-bs-target="#section1" aria-expanded="false" aria-controls="section1">
                    <strong>1. Ngành đào tạo, mã tổ hợp xét tuyển</strong>
                  </button>
                </h2>
                <div id="section1" class="accordion-collapse collapse" data-bs-parent="#announcementAccordion">
                  <div class="accordion-body p-2 fs-7">
                    <p class="mb-1">Danh mục các ngành tuyển sinh đào tạo, tổ hợp, mã tổ hợp môn xét tuyển được quy định trong Phụ lục đính kèm.</p>
                  </div>
                </div>
              </div>
            ...
            <div class="info-box mt-2">
              <p class="mb-0 small">
                ...
                <strong>Phương thức:</strong> Xét kết quả học tập cấp THPT (học bạ)
                <span class="d-block d-sm-inline"><span class="d-none d-sm-inline">|</span> <strong>Mã phương thức:</strong> 200</span>
                <span class="d-block d-sm-inline"><span class="d-none d-sm-inline">|</span> <strong>Điều kiện:</strong> Tốt nghiệp THPT năm 2025 hoặc đã tốt nghiệp THPT các năm trước.</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="card-body py-2">
          ...
          <div v-if="loading" class="text-center py-3" role="status" aria-live="polite">
            ...
            <p class="mt-2 fs-6">Đang tải dữ liệu xét tuyển học bạ...</p>
          </div>
          ...
          <div v-else>
            ...
            <section class="table-container mb-3" aria-labelledby="hocba-table-heading">
              <h2 id="hocba-table-heading" class="visually-hidden">Danh sách ngành xét tuyển học bạ</h2>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body p-2">
                      ...
                      <div class="mb-2 small">
                        <span class="fw-bold">Tổ hợp môn học bạ xét tuyển:</span>
