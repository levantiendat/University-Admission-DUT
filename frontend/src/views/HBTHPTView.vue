    ...
    <div class="container-fluid py-4">
      <div class="card main-card shadow no-copy">
        ...
        <div class="announcement-section p-3 border-bottom">
          <div class="container">
            <h5 class="fw-bold mb-3">Trường Đại học Bách khoa, Đại học Đà Nẵng thông báo tuyển sinh đào tạo trình độ đại học chính quy vào các ngành thuộc Trường năm 2025, theo phương thức xét học bạ trung học phổ thông như sau:</h5>
            
            <div class="mb-3">
              <h6 class="fw-bold">1. Ngành đào tạo, mã tổ hợp xét tuyển</h6>
            ...
            <div class="info-box">
              <p class="mb-0">
                ...
                <strong>Phương thức xét tuyển:</strong> Xét kết quả học tập cấp THPT (học bạ)
                | <strong>Mã phương thức:</strong> 200
                | <strong>Điều kiện:</strong> Thí sinh thi tốt nghiệp THPT năm 2025 hoặc thí sinh đã tốt nghiệp THPT các năm trước.
              </p>
            </div>
          </div>
        </div>
