            ...
            <div class="info-section mt-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mt-3 fs-5">
                    <p>Kỳ thi đánh giá năng lực (ĐGNL) là kì thi do Đại học Quốc gia TPHCM tổ chức, giúp xác định trình độ hiểu biết, kỹ năng cơ bản, tư duy logic và giải quyết vấn đề của thí sinh.</p>
