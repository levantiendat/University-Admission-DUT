<template>
  <div class="dgnl-container">
    <div class="container-fluid py-2 py-md-3">
      <article class="card main-card shadow-sm">
        <!-- Header Section with improved accessibility -->
        <header class="card-header bg-primary text-white" aria-labelledby="dgnl-title">
          <div class="d-flex justify-content-center align-items-center">
            <div class="header-icon me-2" aria-hidden="true">
              <i class="bi bi-journal-check"></i>
            </div>
            <h1 id="dgnl-title" class="mb-0 fs-5">XÉT TUYỂN THEO ĐIỂM THI ĐÁNH GIÁ NĂNG LỰC CỦA ĐHQG TPHCM</h1>
          </div>
        </header>
        ...
        <div class="description-section bg-light p-2 border-bottom">
          <div class="container">
            ...
            <div class="accordion accordion-flush" id="announcementAccordion">
              <!-- Introduction -->
              <p class="mb-2 small">Trường Đại học Bách khoa, Đại học Đà Nẵng thông báo tuyển sinh đào tạo trình độ đại học chính quy vào các ngành thuộc Trường năm 2025 theo phương thức xét tuyển điểm thi đánh giá năng lực.</p>
              ...
              <div class="accordion-item">
                ...
                <div id="section2" class="accordion-collapse collapse" data-bs-parent="#announcementAccordion">
                  <div class="accordion-body p-2 fs-7">
                    <ul class="mb-1 ps-3">
                      <li>Đối tượng: thí sinh đã tốt nghiệp THPT hoặc tương đương và có kết quả kỳ thi đánh giá năng lực của Đại học Quốc gia TPHCM.</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="info-box mt-2">
              <p class="mb-0 small">
                ...
                <strong>Phương thức:</strong> Xét tuyển theo điểm thi ĐGNL của ĐHQG TPHCM
                <span class="d-block d-sm-inline"><span class="d-none d-sm-inline">|</span> <strong>Mã phương thức:</strong> 402</span>
                <span class="d-block d-sm-inline"><span class="d-none d-sm-inline">|</span> <strong>Điều kiện:</strong> Tham dự kỳ thi ĐGNL của ĐHQG TPHCM năm 2025, đạt điểm sàn theo quy định.</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="card-body py-2">
          ...
          <div v-else>
            ...
            <section class="table-container mb-3" aria-labelledby="dgnl-table-heading">
              <h2 id="dgnl-table-heading" class="visually-hidden">Danh sách ngành xét tuyển theo điểm ĐGNL</h2>
              ...
              <div class="table-responsive d-none d-md-block">
                <table class="table table-hover border table-sm">
                  <caption class="visually-hidden">Danh sách ngành xét tuyển theo điểm ĐGNL</caption>
                  <thead>
            ...
            <!-- Info Section about ĐGNL Exam -->
            <section class="info-section mt-3" aria-labelledby="dgnl-info-heading">
              <div class="card">
                <div class="card-body p-2">
                  <h2 id="dgnl-info-heading" class="card-title fs-6 mb-2">
                    <i class="bi bi-info-circle me-2" aria-hidden="true"></i>
                    Thông tin về kỳ thi đánh giá năng lực
                  </h2>
                  <div class="mt-2 small">
                    <p class="mb-2">Kỳ thi đánh giá năng lực (ĐGNL) là kì thi do Đại học Quốc gia TPHCM tổ chức, giúp xác định trình độ hiểu biết, kỹ năng cơ bản, tư duy logic và phân tích của thí sinh.</p>
                    <p class="fw-medium mb-1">Cấu trúc đề thi Đánh giá năng lực:</p>
                    <ul class="mb-2 ps-3">
                      <li>Phần 1: Sử dụng ngôn ngữ (60 Câu hỏi)</li>
                      <li>Phần 2: Toán học (30 Câu hỏi)</li>
                      <li>Phần 3: Tư duy khoa học (30 Câu hỏi)</li>
                    </ul>
                    <p class="fw-medium mb-1">Thang điểm: từ 0 đến 1200, trong đó:</p>
                    <ul class="mb-2 ps-3">
                      <li>Điểm trung bình: khoảng 550-650</li>
                      <li>Điểm cao: từ 800 trở lên</li>
                    </ul>
                    <p class="mb-0">Thí sinh cần đạt ngưỡng điểm sàn do nhà trường quy định để đủ điều kiện xét tuyển vào các ngành học.</p>
                  </div>
                </div>
              </div>
            </section>
