<template>
    <div class="admin-subject-group-create">
      ...
      <div class="admin-card mb-4">
        <form @submit.prevent="createSubjectGroup" class="create-form">
      ...
      <div class="alert alert-info">
        ...
        <strong>Lưu ý:</strong> Sau khi tạo tổ hợp môn thi, bạn sẽ có thể thêm các môn học vào tổ hợp này.
      </div>
    </div>
  </template>
    ...
    setup() {
      ...
      const createSubjectGroup = async () => {
        try {
          ...
          const newGroup = await SubjectGroupController.createSubjectGroup(formData)
