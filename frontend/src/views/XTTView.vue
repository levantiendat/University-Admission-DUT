      ...
      <div class="card main-card shadow">
        ...
        <div class="description-section bg-light p-3 border-bottom">
          <div class="container">
            <p class="description-text mb-0">
              ...
              <strong>Phương thức xét tuyển:</strong> Xét tuyển thẳng theo quy chế của Bộ Giáo dục và Đào tạo
              | <strong>Mã phương thức:</strong> 301
              | <strong>Điều kiện:</strong> Thí sinh đạt giải Nhất, Nhì, Ba giải học sinh giỏi cấp quốc gia hoặc kỳ thi khoa học kỹ thuật cấp quốc gia. Lĩnh vực / Môn học đạt giải phải phù hợp với ngành đăng kí xét tuyển.
            </p>
          </div>
        </div>
        ...
        <div class="card-body">
          <div v-if="loading" class="text-center py-5">
            ...
            <p class="mt-3 fs-5">Đang tải dữ liệu xét tuyển thẳng...</p>
          </div>
