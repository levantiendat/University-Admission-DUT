<template>
  <div class="xtt-container bg-light">
    <div class="container-fluid py-4">
      <div class="card main-card shadow no-copy">
        ...
        <div class="announcement-section p-3 border-bottom">
          <div class="container">
            <h5 class="fw-bold mb-3">Trường Đại học Bách khoa (ĐHBK), Đại học Đà Nẵng thông báo tuyển sinh đào tạo trình độ đại học hệ chính quy năm 2025 theo phương thức tuyển thẳng và ưu tiên xét tuyển theo quy định của Bộ Giáo dục và Đào tạo (GDĐT) như sau:</h5>
            
            <div class="mb-3">
              <h6 class="fw-bold">1. Ngành tuyển sinh, chỉ tiêu và tiêu chí xét tuyển</h6>
              <p class="mb-1">Xem Danh sách dưới đây</p>
            </div>
            
            <div class="mb-3">
              <h6 class="fw-bold">2. Vùng tuyển, chính sách ưu tiên</h6>
              <ul class="mb-2 ps-3">
            ...
            <div class="mb-3">
              <h6 class="fw-bold">3. Đối tượng xét tuyển</h6>
              ...
              <p class="mb-1"><strong>b) Thí sinh đoạt giải nhất, nhì, ba trong kỳ thi chọn học sinh giỏi quốc gia, quốc tế các môn Toán, Vật lý, Hóa học, Sinh học, Tin học do Bộ GDĐT tổ chức, cử tham gia; thời gian đoạt giải không quá 3 năm tính tới thời điểm xét tuyển thẳng.</strong></p>
              <p class="mb-1">Thí sinh tốt nghiệp THPT năm 2025.</p>
              <p class="mb-1">Xem Phụ lục II</p>
              
              <p class="mb-1"><strong>c) Thí sinh đoạt giải nhất, nhì, ba trong kỳ thi khoa học, kỹ thuật cấp quốc gia, quốc tế do Bộ GDĐT tổ chức, cử tham gia; thời gian đoạt giải không quá 3 năm tính tới thời điểm xét tuyển thẳng.</strong></p>
              <p class="mb-1">Thí sinh tốt nghiệp THPT năm 2025.</p>
              <p class="mb-1">Xem Phụ lục III</p>
            </div>
            
            <div class="mb-3">
              <h6 class="fw-bold">4. Nguyên tắc xét tuyển</h6>
              <ul class="mb-2 ps-3">
                <li>Xét tuyển vào ngành đúng trước, sau đó xét tuyển vào ngành gần. Thí sinh có thể đăng ký tuyển thẳng vào nhiều ngành khác nhau, theo thứ tự ưu tiên. Xét theo thứ tự giải từ cao xuống thấp cho đến khi đủ chỉ tiêu và ưu tiên từ nguyện vọng 1 cho đến hết.</li>
                <li>Mỗi thí sinh trúng tuyển 1 nguyện vọng sẽ không được xét tuyển các nguyện vọng tiếp theo.</li>
              </ul>
            </div>
            
            <div class="mb-3">
              <h6 class="fw-bold">5. Hồ sơ và lệ phí đăng ký xét tuyển:</h6>
              <ul class="mb-2 ps-3">
                <li>Thời gian nhận hồ sơ: Thông báo sau.</li>
                <li>Đối với ngành Kiến trúc, thí sinh phải dự thi môn năng khiếu "Vẽ mỹ thuật", do Hội đồng thi năng khiếu Vẽ mỹ thuật năm 2025 của Trường Đại học Bách khoa, Đại học Đà Nẵng tổ chức.</li>
                <li>Đăng ký và nộp hồ sơ xét tuyển: theo hình thức trực tuyến, tại địa chỉ: <a href="https://tuyensinh.dut.udn.vn/" target="_blank">https://tuyensinh.dut.udn.vn/</a></li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div class="card-body">
                  ...
                  <div class="mt-2">
                    <ul class="contact-list">
                      ...
                      <li>Zalo: <a href="https://zalo.me/dhbkdn2022" target="_blank">https://zalo.me/dhbkdn2022</a></li>
