      ...
      <div class="card main-card shadow no-copy">
        ...
        <div class="card-body">
          <div v-if="loading" class="text-center py-5">
            ...
            <p class="mt-3 fs-5">Đang tải dữ liệu xét tuyển...</p>
          </div>
              ...
              <table class="table table-hover border">
                <thead>
                  <tr class="bg-primary text-white">
                    ...
                    <th scope="col" style="width: 50%">Tên ngành</th>
                    <th scope="col" class="text-center" style="width: 30%">Chỉ tiêu</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div class="info-section mt-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mt-3 fs-5">
                    <p>Kỳ thi đánh giá tư duy (ĐGTD) là một kì thi do Đại học Bách Khoa Hà Nội tổ chức, nhằm đánh giá khả năng tư duy logic, giải quyết vấn đề và tiềm năng phát triển của thí sinh.</p>
