<template>
  <div class="dgtd-container bg-light">
    <div class="container-fluid py-4">
      <div class="card main-card shadow no-copy">
        ...
        <div class="announcement-section p-3 border-bottom">
          <div class="container">
            <h5 class="fw-bold mb-3">Trường Đại học Bách khoa, Đại học Đà Nẵng thông báo tuyển sinh đào tạo trình độ đại học chính quy vào các ngành thuộc Trường năm 2025, theo phương thức xét kết quả thi Đánh giá tư duy do Đại học Bách khoa Hà Nội tổ chức như sau:</h5>
            ...
            <div class="mb-3">
              ...
              <ul class="mb-2 ps-3">
                <li>Đối tượng: thí sinh đã tốt nghiệp trung học phổ thông hoặc tương đương và có kết quả kỳ thi Đánh giá tư duy do Đại học Bách khoa Hà Nội tổ chức năm 2025.</li>
              </ul>
            </div>
            ...
            <div class="info-box">
              <p class="mb-0">
                ...
                <strong>Phương thức xét tuyển:</strong> Xét tuyển theo điểm thi đánh giá tư duy của Đại Học Bách Khoa Hà Nội
                | <strong>Mã phương thức:</strong> 402
                | <strong>Điều kiện:</strong> Thí sinh tham dự kỳ thi đánh giá tư duy của Đại Học Bách Khoa Hà Nội tổ chức năm 2024, 2025 và đạt điểm sàn theo quy định.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="info-section mt-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mt-3">
                    <p>Kỳ thi đánh giá tư duy (ĐGTD) là một kì thi do Đại học Bách Khoa Hà Nội tổ chức, nhằm đánh giá khả năng tư duy logic, giải quyết vấn đề của thí sinh.</p>
                    <p class="fw-medium">Cấu trúc đề thi Đánh giá tư duy:</p>
                    <ul>
                    ...
                    <p class="fw-medium">Thang điểm: từ 0 đến 100, trong đó:</p>
                    <ul>
                      <li>Điểm trung bình: khoảng 45-55</li>
                      <li>Điểm cao: từ 65 trở lên</li>
                    </ul>
                    <p>Thí sinh cần đạt ngưỡng điểm sàn do trường quy định để đủ điều kiện xét tuyển vào các ngành học.</p>
                  </div>
                </div>
              </div>
            </div>
