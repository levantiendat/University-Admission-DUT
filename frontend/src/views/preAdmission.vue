<template>
        ...
        <div v-else-if="viewMode === 'chart'" class="chart-container">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select id="chart-method-select" class="form-select" v-model="selectedMethodForChart">
                      ...
                      <option v-for="method in displayedMethods" :key="method.id" :value="method.id">
          ...
          <div v-else-if="chartViewType === 'faculty'" class="faculty-charts">
            ...
            <div v-if="selectedFacultyForChart" class="chart-wrapper">
              <h3 class="chart-title">
                Biểu đồ điểm chuẩn năm {{ selectedYearForChart }} - 
          ...
          <div v-else-if="chartViewType === 'university'" class="university-charts">
            ...
            <div class="chart-wrapper">
              <h3 class="chart-title">
                Biểu đồ điểm chuẩn toàn trường năm {{ selectedYearForChart }}
                <template v-if="selectedMethodForChart !== 'all'">
                  - {{ getMethodById(selectedMethodForChart)?.name }}
                </template>
              </h3>
  ...
  export default {
    ...
    data() {
      return {
        ...
        charts: {},
        currentUser: 'levantiendatMỗi',
        currentDate: '2025-04-20 15:29:54' // Ngày giờ hiện tại
      }
    },
    computed: {
      faculties() {
    ...
    methods: {
      ...
      getMethodColor(methodId) {
        return preAdmissionController.getColorForMethod(methodId)
      },
      ...
      renderSingleMethodMajorChart(majorData, method, isSingleMethod = false) {
        ...
        const chartData = {
          ...
          datasets: [{
            ...
            borderColor: this.getMethodColor(methodId).replace('0.7', '1'),
            borderWidth: 1
          }]
        }
            ...
            options: {
              ...
              scales: {
                y: {
                  ...
                  max: this.getMaxScoreForMethod(methodId), // Đến điểm tối đa của phương thức
                  title: {
                    display: true,
                    text: 'Điểm'
                  }
  ...
  @media (max-width: 768px) {
    ...
    .filters .col-md-4, .filters .col-md-6 {
      width: 100%;
      margin-bottom: 1rem;
    }
  }
